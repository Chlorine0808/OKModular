...
import ruiseki.okmodular.client.nei.modular.layout.LayoutPartFluid;
import ruiseki.okmodular.client.nei.modular.layout.LayoutPartGas;
import ruiseki.okmodular.client.nei.modular.layout.LayoutPartItem;
import ruiseki.okmodular.client.nei.modular.layout.LayoutPartMana;
import ruiseki.okmodular.client.nei.modular.layout.LayoutPartRenderer;
import ruiseki.okmodular.client.nei.modular.layout.LayoutPartVis;
import ruiseki.okmodular.client.nei.modular.layout.RecipeLayoutPart;
import ruiseki.okmodular.client.nei.modular.renderer.INEIPositionedRenderer;
import ruiseki.okmodular.client.nei.modular.renderer.PositionedText;
        ...
        private void layout() {
            ...
            if (!requiredTiers.isEmpty()) {
                ...
                PositionedText tierHeaderText = new PositionedText(
                    StatCollector.translateToLocal("okmodular.nei.required_tiers"),
                    0x444444,
                    new Rectangle(0, currentY, 166, 10));
                ...
                for (Map.Entry<String, Integer> entry : requiredTiers.entrySet()) {
                    String componentName = StatCollector.translateToLocal("okmodular.component." + entry.getKey());
                    String tierVal = StatCollector
                        .translateToLocalFormatted("okmodular.nei.tier_format", entry.getValue());
