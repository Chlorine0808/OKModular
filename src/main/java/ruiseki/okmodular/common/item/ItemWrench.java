...
public class ItemWrench extends ItemOK implements IToolHammer {
        ...
        if (player.isSneaking()) {
            ...
            if (te instanceof IMachineController) {
                if (!world.isRemote) {
                    ...
                    player.addChatMessage(new ChatComponentTranslation("chat.okmodular.wrench_linked", x, y, z));
                    return true;
                }
                return false;
            }
        ...
        if (player.isSneaking()) {
            ...
            if (!world.isRemote) {
                ...
                if (nbt != null) {
                    ...
                    player.addChatMessage(new ChatComponentTranslation("chat.okmodular.wrench_unlinked"));
                }
            }
    ...
    // ItemOK.registerIcons prefixes the OKCore domain; register under okmodular instead
    @Override
    public void registerIcons(IIconRegister register) {
        itemIcon = register
            .registerIcon(Reference.PREFIX_MOD + (getTextureName() != null ? getTextureName() : getName()));
    }
}
